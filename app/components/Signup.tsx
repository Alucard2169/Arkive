...
<Button type="button" variant="outline" className="flex bg-white text-black font-bold gap-2 items-center w-1/2 mr-auto ml-auto">
  ...
  Continue with Google
        ...
        {/* Submit Button */}
        <Button type="submit" variant="outline" className="cursor-pointer w-1/2 mr-auto ml-auto">Submit</Button>
      </form>
    </Form>
  );
}
